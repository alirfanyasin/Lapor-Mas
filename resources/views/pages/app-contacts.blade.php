...
@section('content')
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-7.5">
    ...
    <div class="card overflow-hidden">
      <!-- Cover Image Section -->
      <div class="relative">
        <img class="w-full h-44 object-cover" src="{{ asset('assets/images/small/img-1.jpg') }}" alt="Cover Image">
        ...
        <div class="absolute -bottom-14 start-1/2 transform -translate-x-1/2">
          <div class="relative">
            <img class="w-28 h-28 rounded-full border-4 border-white shadow-md"
              src="{{ asset('assets/images/users/avatar-1.jpg') }}" alt="Profile Picture">
    ...
    <div class="card overflow-hidden">
      <div class="relative">
        <img class="w-full h-44 object-cover" src="{{ asset('assets/images/small/img-2.jpg') }}" alt="Cover Image">
        <div class="absolute -bottom-14 start-1/2 transform -translate-x-1/2">
          <div class="relative">
            <img class="w-28 h-28 rounded-full border-4 border-white shadow-md"
              src="{{ asset('assets/images/users/avatar-2.jpg') }}" alt="Profile Picture">
      ...
      <div class="py-4 px-6">
        <div class="flex justify-center space-x-6">
          <a href="#" class="text-primary hover:text-blue-700 transition-all"><i
              class="i-ph-facebook-logo text-3xl"></i></a>
          <a href="#" class="text-pink-500 hover:text-pink-700 transition-all"><i
              class="i-ph-instagram-logo text-3xl"></i></a>
          <a href="#" class="text-blue-700 hover:text-blue-900 transition-all"><i
              class="i-ph-linkedin-logo text-3xl"></i></a>
          <a href="#" class="text-default-700 hover:text-default-900 transition-all"><i
              class="i-ph-x-logo text-3xl"></i></a>
        </div>
      </div>
      <div class="pb-4 px-6 flex justify-center space-x-4">
        <button class="btn bg-primary text-white">Follow</button>
    ...
    <div class="card overflow-hidden">
      <div class="relative">
        <img class="w-full h-44 object-cover" src="{{ asset('assets/images/small/img-3.jpg') }}" alt="Cover Image">
        <div class="absolute -bottom-14 start-1/2 transform -translate-x-1/2">
          <div class="relative">
            <img class="w-28 h-28 rounded-full border-4 border-white shadow-md"
              src="{{ asset('assets/images/users/avatar-3.jpg') }}" alt="Profile Picture">
    ...
    <div class="card overflow-hidden">
      <div class="relative">
        <img class="w-full h-44 object-cover" src="{{ asset('assets/images/small/img-4.jpg') }}" alt="Cover Image">
        <div class="absolute -bottom-14 start-1/2 transform -translate-x-1/2">
          <div class="relative">
            <img class="w-28 h-28 rounded-full border-4 border-white shadow-md"
              src="{{ asset('assets/images/users/avatar-4.jpg') }}" alt="Profile Picture">
    ...
    <div class="card overflow-hidden">
      <div class="relative">
        <img class="w-full h-44 object-cover" src="{{ asset('assets/images/small/img-5.jpg') }}" alt="Cover Image">
        <div class="absolute -bottom-14 start-1/2 transform -translate-x-1/2">
          <div class="relative">
            <img class="w-28 h-28 rounded-full border-4 border-white shadow-md"
              src="{{ asset('assets/images/users/avatar-5.jp') }}g" alt="Profile Picture">
            <span class="absolute bottom-1 end-1 w-5 h-5 bg-green-500 border-2 border-white rounded-full"></span>
          </div>
        </div>
      </div>
    ...
    <div class="card overflow-hidden">
      <div class="relative">
        <img class="w-full h-44 object-cover" src="{{ asset('assets/images/small/img-6.jpg') }}" alt="Cover Image">
        <div class="absolute -bottom-14 start-1/2 transform -translate-x-1/2">
          <div class="relative">
            <img class="w-28 h-28 rounded-full border-4 border-white shadow-md"
              src="{{ asset('assets/images/users/avatar-6.jpg') }}" alt="Profile Picture">
            <span class="absolute bottom-1 end-1 w-5 h-5 bg-red-500 border-2 border-white rounded-full"></span>
          </div>
        </div>
      </div>
